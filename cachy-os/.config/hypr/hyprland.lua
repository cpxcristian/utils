...
hl.config({
    env = {
        "VDPAU_DRIVER,va_gl",
        "LIBVA_DRIVER_NAME,i965",           -- Driver de aceleración de video para Intel HD
        "WLR_NO_HARDWARE_CURSORS,0",        -- Habilita cursores por hardware
    }
})
...
-- end)
hl.on("hyprland.start", function () 
  hl.exec_cmd("uwsm app -- noctalia --daemon")
...
hl.bind(mainMod .. " + SHIFT + minus",  hl.dsp.exec_cmd("playerctl next"), { locked = true })
-- hl.bind(mainMod .. " + SHIFT + {", hl.dsp.exec_cmd("playerctl play-pause"), { locked = true })
-- hl.bind(mainMod .. " + SHIFT + ñ",  hl.dsp.exec_cmd("playerctl play-pause"), { locked = true })
-- hl.bind(mainMod .. " + SHIFT + .",  hl.dsp.exec_cmd("playerctl previous"), { locked = true })
...
hl.layer_rule({
    ...
    match = { 
        namespace = "noctalia-.*" -- Captura la barra, el menú y todos los daemons al mismo tiempo
    },
    blur = true,
    ignore_alpha = 0.1
})
